<?php
	...
	$conf['servers'][0]['desc'] = isset($_COOKIE['pg4e_desc']) ? $_COOKIE['pg4e_desc'] : 'not.configured';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][0]['host'] = isset($_COOKIE['pg4e_host']) ? $_COOKIE['pg4e_host'] : 'not.configured';
	...
	// $conf['servers'][0]['desc'] = 'Test Server';
	// $conf['servers'][0]['host'] = '34.68.205.153';
	// $conf['servers'][0]['port'] = 5432;
