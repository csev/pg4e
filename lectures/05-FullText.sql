...
-- _text_ops means that it is expecting text[] (arrays of strings)
...
-- Of course PostgreSQL makes this all so much easier and more efficient :)

-- ts_vector is an special "array" of stemmed words and a stop-word 
...
-- ts_query is an "array" of lower case, pre-stemmed words with 
