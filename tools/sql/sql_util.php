...
Password: <span id="pass" style="display:none"><input type="text" name="pdo_pass" id="pdo_pass" value="<?= htmlentities($pdo_pass) ?>"/></span> (<a href="#" onclick="$('#pass').toggle();return false;">hide/show</a> <a href="#" onclick="copyToClipboard(''<?= htmlentities($pdo_pass) ?>);return false;">copy</a>) <br/>
</pre>
<?php } else { ?>
<p>
<pre>
...
Password: <span id="pass" style="display:none"><?= $pdo_pass ?></span> <input type="hidden" name="pdo_pass" id="pdo_pass" value="<?= htmlentities($pdo_pass) ?>"/> (<a href="#" onclick="$('#pass').toggle();return false;">hide/show</a> <a href="#" onclick="copyToClipboard(''<?= htmlentities($pdo_pass) ?>);return false;">copy</a>)
</pre>
</p>
<?php } ?>
