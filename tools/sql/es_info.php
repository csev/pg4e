...
$url = addSession("es_info.php?dbname=".urlencode($dbname));
...
if ( U::get($_POST,'create') ) {
    ...
    $_SESSION['pg4e_request_status'] = $pg4e_request_status;
    ...
    $retval = pg4e_request($dbname, 'info/es', $cfg);
    $_SESSION['operation'] = 'delete';
    $_SESSION['pg4e_request_result'] = $pg4e_request_result;
    $_SESSION['pg4e_request_url'] = $pg4e_request_url;
    $_SESSION['pg4e_request_status'] = $pg4e_request_status;
...
$pg4e_request_status = U::get($_SESSION,'pg4e_request_status', null);
unset($_SESSION['pg4e_request_result']);
unset($_SESSION['pg4e_request_url']);
unset($_SESSION['pg4e_request_status']);
...
if ( $pg4e_request_result != null ) {
    ...
    echo("</p>\n");
    echo("<p>HTTP Status: \n");
    echo(htmlentities($pg4e_request_status));
    echo("</p>\n");
    echo("<hr/>\n<pre>\n");
    echo("Returned data:\n");
